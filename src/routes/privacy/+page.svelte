...
<main class="copy">
	...
	<p>
		EchoVerse collects your name to optimize the simulated chatting experience. This information is
	...
	<p>
		The chatbots in this application are powered by OpenAI. Any information you send in the chat
